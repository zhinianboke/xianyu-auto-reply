...
class AutoRelistRule(Base):
    ...
    __table_args__ = (
        ...
        Index("idx_auto_relist_user_enabled_due", "user_id", "enabled", "next_retry_at"),
        Index("idx_auto_relist_account_item", "account_id", "current_item_id"),
    )
    ...
    last_order_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    last_order_updated_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
